#!/bin/sh
### --- Job Name ---
#BSUB -J multi_simple_job

### --- Log files ---
#BSUB -o /zhome/d2/4/167803/Desktop/Deep_project/02456-final-project/logs/multi_simple_job_%J.out
#BSUB -e /zhome/d2/4/167803/Desktop/Deep_project/02456-final-project/logs/multi_simple_job_%J.err
### --- Resource Requests ---
...
#BSUB -R "rusage[mem=50GB]"   # Request 16GB memory
